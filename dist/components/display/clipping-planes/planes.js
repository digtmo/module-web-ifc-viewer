...
export class IfcPlane extends IfcComponent {
    constructor(context, origin, normal, onStartDragging, onEndDragging, planeSize, edgesEnabled) {
        ...
        this.isVisible = false; // probando con variable false (no veo cambios)
        this.enabled = true; // probando con variable false (movimiento de las flechas)
        this.edgesActive = false; // probando en false (no veo cambios)
